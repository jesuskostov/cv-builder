        ...
        <div class="row pt-4">
            <div class="col-md-8 mx-auto mb-4">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <p class="text-left text pl-md-3 pl-0">
                            <b>Your CV is your personal presentation to the prospective employer.</b> It needs to represent your professional profile as best as is possible by <b>marketing you as a new asset for the company.</b> It must be individual and customised to the vacancy you’re applying for and overall it must be convincing, because that is your ultimate aim – to convince the employer that you are the right candidate to invite for an interview!                            
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-8 mx-auto mb-4">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <p class="text-left text pl-md-3 pl-0">
                            When it comes to getting down to the basics of how to write a curriculum vitae, there are several elements that each candidate must bear in mind. <br><br>
                            <ul>
                                <li><b>A CV or curriculum vitae, often referred to as a resume in the US</b>, is defined as an account of an <b>applicant’s work experience, education and qualifications</b> sent when applying for a job. This is a basic definition for something that must essentially provoke in the reader an urge to want to meet you, therefore learning <b>how to write a CV</b> for a job application must also <b>embrace the notion of writing a story to intrigue the reader</b>, in this case a hiring manager.</li><br>
                                <li>When a candidate decides <b>how to prepare a CV for their job search</b>, he or she <b>must begin by making a plan</b> which encompasses their professional achievements, work history, education, qualities and skills that they can bring to the position and any extra qualifications that make them a suitable candidate.</li><br>
                                <li>This <b>information needs to then be presented in a descriptive but professional manner</b> which showcases the strengths of each individual and their aptitude for the vacancy. You must <b>approach CV writing from the perspective of your audience</b> and treat each CV as an individual and new application, not copying and pasting the same material for every different job vacancy available.</li><br>
                                <li><b>Research the company and the position</b>, read up on what your duties would be and think about how you would tackle problems that might arise or how your accomplishments and skills would benefit the company you’d like to work for.</li>
                            </ul>
                        </p>
                    </div>
                </div>
            ...
            <div class="col-md-8 mx-auto mb-4">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <p class="text-left text pl-md-3 pl-0">
                            It’s crucial to <b>think carefully about your CV format</b> when you write it. If you choose to do so from scratch you’ll have to plan carefully how to place each section, creating a layout which is easy on the eyes, making good use of white space and not cluttering the page with different fonts, sizes and typefaces. <br><br>
                    ...
                    <div class="col-md-12">
                        <div class="text-left text pl-md-3 pl-0">
                            ...
                            <ul>
                                ...
                                <li>Finally, as CVs evolve and the HR community changes, you are advised not to include&nbsp;<a href="https://www.online-cv.co.uk/write-a-cv/references/">references on your CV</a>&nbsp;at any point unless strictly requested by the job vacancy. In some cases candidates can choose to add a line at the end of the CV to mention that &lsquo;references are available on request&rsquo;.</li>
                            </ul>
