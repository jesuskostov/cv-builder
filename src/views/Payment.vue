          ...
          <form @submit.prevent="onSubmit">
            <div class="payment h-100 d-flex flex-column">
              <div>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <label>{{ $t("payment.amount") | formattedLabel }}</label>
                  </div>
                  <div class="col-md-8">
                ...
                <div class="row mb-4">
                  <div class="col-md-4">
                    <label>{{ $t("payment.cardType") | formattedLabel }}</label>
                  </div>
                  <div class="col-md-8">
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-4">
                      <label for="firstName">
                        {{ $t("payment.cardHolder") | formattedLabel }}
                      </label>
                    </div>
                    <div class="col-md-8">
                      <input
                        ...
                        class="form-control"
                        name="firstName"
                        :data-vv-as="$t('payment.cardHolder') | addQuotes"
                        id="firstName"
                        v-model="firstName"
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <label for="creditCard">
                        {{ $t("payment.cardNumber") | formattedLabel }}
                      </label>
                    </div>
                    <div class="col-md-8">
                      <the-mask
                        :mask="['#### #### #### ####']"
                        v-model="cardNumber"
                        :data-vv-as="$t('payment.cardNumber') | addQuotes"
                        name="creditCard"
                        id="creditCard"
                        class="form-control"
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      ...
                      <span class="error">{{
                        errors.first("expiryMonth")
                      }}</span>
                      <span class="error">{{
                        errors.first("expiryYear")
                      }}</span>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-4">
                      <label for="cvv">
                        {{ $t("payment.cardCVV") | formattedLabel }}
                      </label>
                    </div>
                    <div class="col-md-8">
                      <div class="d-flex align-items-center">
                        <span class="mr-2">
                          <the-mask
                            :mask="['###']"
                            v-model="cvv"
                            :data-vv-as="$t('payment.cardCVV') | addQuotes"
                            name="cvv"
                            id="cvv"
                            class="form-control"
                            size="3"
          ...
          <div class="preview">
            <div class="row mb-1">
              ...
              <div class="col-md-7">
                <h2>{{ $t("downloadCV") }}</h2>
                <hr />
                <div class="personal-info" v-if="personal">
                  <p class="mb-0">
                    {{ $t("cvPayInfo.name")
            ...
            <ul v-if="plan === 'Achat Solo'" class="mt-3 pl-0">
              <li
                v-for="(text, i) in $t('plan.benefits')"
                :key="i"
                class="d-flex items-left mb-1"
                :class="{ overline: i >= 2 }"
              >
