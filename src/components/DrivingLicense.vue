<template>
  <div>
       <div class="accordion px-4 py-4">
        ...
        <multiselect v-model="licenses" class="w-100" :options="predefined" :multiple="true" :close-on-select="false" :clear-on-select="false" :preserve-search="true" placeholder="Choose driving license" label="title" track-by="title" />
